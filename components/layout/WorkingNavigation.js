...
// Working navigation component with reliable navigation
export default function WorkingNavigation({ children }) {
        ...
        <header className="bg-white border-b border-gray-200 px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <Link href="/transactions/returns" className="p-2 rounded-lg hover:bg-gray-100 transition-colors" aria-label="Returns">
                <RotateCcwIcon className="h-5 w-5 text-gray-600" />
              </Link>
              <Link href="/suppliers" className="p-2 rounded-lg hover:bg-gray-100 transition-colors" aria-label="Suppliers">
                <TruckIcon className="h-5 w-5 text-gray-600" />
              </Link>
              <Link href="/reports" className="p-2 rounded-lg hover:bg-gray-100 transition-colors" aria-label="Reports">
